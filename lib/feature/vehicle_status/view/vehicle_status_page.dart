    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: BlocConsumer<VehicalCubit, VehicalState>(
            ...
            builder: (context, state) {
              if (state is LoadingVehicalState) {
              ...
              } else if (state is SuccessVehicalState) {
                final vehicleList = state.data;
                final selectedVehicle = vehicleList
                    .where((element) => element.status == VehicleStatus.active)
                    .first;
                return Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            "${AppStrings.of(context).vehicleName} - ${selectedVehicle.brandName} - ${selectedVehicle.modelName} - ${selectedVehicle.year}",
                ...
                return Center(child: Text("There Are no State"));
              }
            },
          ),
        ),
